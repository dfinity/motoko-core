...
let suite = Suite.suite(
  ...
  [
    ...
    Suite.test(
      ...
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 0, 5),
      M.equals(T.array(T.natTestable, [2, 4, 6, 8, 10]))
    ),
    Suite.test(
      "subArray if including all but last index",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 0, -1),
      M.equals(T.array(T.natTestable, [2, 4, 6, 8]))
    ),
    Suite.test(
      "subArray if including all but first index",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 1, 5),
      M.equals(T.array(T.natTestable, [4, 6, 8, 10]))
    ),
    Suite.test(
      "subArray if including middle of array",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 1, 4),
      M.equals(T.array(T.natTestable, [4, 6, 8]))
    ),
    Suite.test(
      "subArray if including middle of array (negative indices)",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], -4, -1),
      M.equals(T.array(T.natTestable, [4, 6, 8]))
    ),
    Suite.test(
      "subArray if including start, but not end of array",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 0, -2),
      M.equals(T.array(T.natTestable, [2, 4, 6]))
    ),
    Suite.test(
      "subArray if including end, but not start of array",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], 2, 5),
      M.equals(T.array(T.natTestable, [6, 8, 10]))
    ),
    Suite.test(
      "subArray if including end, but not start of array (negative indices)",
      VarArray.subArray<Nat>([var 2, 4, 6, 8, 10], -3, 5),
      M.equals(T.array(T.natTestable, [6, 8, 10]))
    ),
    Suite.test(
      "subArray with empty result when start >= end",
      VarArray.subArray<Nat>([var 1, 2, 3, 4, 5], 3, 2),
      M.equals(T.array<Nat>(T.natTestable, []))
    ),
    Suite.test(
      "subArray with negative fromInclusive and positive toExclusive",
      VarArray.subArray<Nat>([var 1, 2, 3, 4, 5], -2, 4),
      M.equals(T.array(T.natTestable, [4]))
    ),
    Suite.test(
      "subArray with negative fromInclusive and zero toExclusive",
      VarArray.subArray<Nat>([var 1, 2, 3, 4, 5], -2, 0),
      M.equals(T.array<Nat>(T.natTestable, []))
    ),
    Suite.test(
      "subArray with both negative indices where start > end",
      VarArray.subArray<Nat>([var 1, 2, 3, 4, 5], -1, -3),
      M.equals(T.array<Nat>(T.natTestable, []))
    ),
    Suite.test(
      "nextIndexOf start",
