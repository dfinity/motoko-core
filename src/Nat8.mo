...
module {
  ...
  /// ```
  public func fromNat(x : Nat): Nat8 {
    Prim.natToNat8(x);
  };
  ...
  /// ```
  public func fromNat16(x : Nat16): Nat8 {
    Prim.nat16ToNat8(x);
  };
  ...
  /// ```
  public func toNat16(x : Nat8): Nat16 {
    Prim.nat8ToNat16(x);
  };
  ...
  /// ```
  public func fromIntWrap(x : Int): Nat8 {
    Prim.intToNat8Wrap(x);
  };
